                ...
                <div class="row">
                      <div class="col-lg-5">
                            <div class="card">
                                ...
                                <img id="imgDigital" alt="Mountain View" width="380" height="235">
                ...
                <div class="row">
                      <div class="col-lg-5">
                            <div class="card">
                                ...
                                <img id="imgEnterprise" alt="Mountain View" width="380" height="235">
                ...
                <div class="row">
                      <div class="col-lg-5">
                            <div class="card">
                                ...
                                <img id="imgKnowledge" alt="Mountain View" width="380" height="235">
