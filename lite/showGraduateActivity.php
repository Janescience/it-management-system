        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h2 class="text-themecolor">Graduate Activity <h5 class="text-themecolor">Graduate Degree</h5></h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Student</a></li>
                        <li class="breadcrumb-item active">Show Graduate Activity</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="card-block">
                  ...
                  <h4>Graduate Degrees</h4>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <div align="right" class="form-group">
                              <button id="DeleteGraduateActivity" class="btn btn-danger"><i class="fa fa-minus"></i>   ลบ</button>
                            </div>
                          </div>
                          <div class="col-md-3">
                          </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                          <div align="right" class="">
                            <button id="EditGraduateActivity" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>   แก้ไข</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                          <div align="right" class="">
                            <button id="EditGraduateActivityImage" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>   แก้ไข</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                          <div align="right" class="">
                            <button id="EditGraduateActivityVideo" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>   แก้ไข</button>
