      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h6 class="card-subtitle">วิชาที่เปิดสอน ระดับปริญญาเอก</h6>
                ...
                <div class="row">
                      <div class="col-lg-5">
                            <div class="card">
                                ...
                                <input class="btn btn-outline-inverse col-md-12" type="file" id="fileUploadImageTopic2">
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h5 class="card-title">หลักสูตรระดับดุษฎีบัณฑิต</h5>
                                ...
                                <textarea class="form-control" rows="4" cols="75" id="textMasterDegreePlan2Detail" >
                                    
                                </textarea>

                                <textarea class="form-control" rows="4" cols="75" id="textMasterDegreePlan2Detail2" >
                                    
                                </textarea>

                                <textarea class="form-control" rows="4" cols="75" id="textMasterDegreePlan2Detail3" >
                                ...
                                <button type="button" id="btModifyTopic2Detail1"  class="btn btn-outline-secondary">แก้ไขแผนการเรียนที่ 1 <i class="fa fa-edit"></i></button>

                                <button type="button" id="btModifyTopic2Detail2"  class="btn btn-outline-secondary">แก้ไขแผนการเรียนที่ 2 <i class="fa fa-edit"></i></button>

                                <button type="button" id="btModifyTopic2Detail3"  class="btn btn-outline-secondary">แก้ไขแผนการเรียนที่ 3 <i class="fa fa-edit"></i></button>
            ...
            <div class="row">
                <div class="col-lg-6">
                            <div class="card">
                                ...
                                <h6 class="card-subtitle">หลักสูตรปรัชญาดุษฎีบัณฑิต (หลักสูตรปรับปรุง พ.ศ. 2558)   </h6> 
...
<script src="../js/doctorate2558.js"></script>
